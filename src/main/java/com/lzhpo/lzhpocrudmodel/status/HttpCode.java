package com.lzhpo.lzhpocrudmodel.status;
...
public enum HttpCode {
     ...
     * @deprecated in favor of {@link #FOUND} which will be returned from {@code HttpCode.valueOf(302)}
     */
    @Deprecated
     ...
     * returned from {@code HttpCode.valueOf(413)}
     */
    @Deprecated
     ...
     * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code HttpCode.valueOf(414)}
     */
    @Deprecated
    ...
    HttpCode(int code, String codeMsg) {
        this.code = code;
